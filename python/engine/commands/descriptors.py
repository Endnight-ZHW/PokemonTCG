...
_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "register_aura_damage_reduction": _descriptor(args={"priority": I, "reduction": NNI, "requires_attached_energy": B}, semantic_kind="aura_damage_reduction", preflight="always"),
