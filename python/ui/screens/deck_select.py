...
DECK_OPTIONS = [
    ...
    },
    {
        ...
        "color": (70, 70, 90),
        "type_icon": "🌑",
        "strategy": "獒教父ex「恫吓」压低返击伤害，「自尊獠牙」在备战受伤时爆发。嘟嘟利自伤过牌，暗黑补丁从弃牌区加速恶能量。",
        "ace": "獒教父ex — 自尊獠牙 (100+120追加) / 恫吓 (30且下回合对手伤害-50)",
        "support": "嘟嘟利(自伤抽牌)、阿勃梭鲁(全场点伤)、达克莱伊(睡眠+高伤)、莫鲁贝可(物品回收)",
        "difficulty": "中等 — 需要主动制造己方备战伤害并管理弃牌区能量",
    },
]
