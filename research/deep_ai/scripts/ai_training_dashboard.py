...
STATIC_ROOT = RESEARCH_ROOT / "tools" / "ai_training_dashboard"
for import_root in (PYTHON_ROOT,):
    if str(import_root) not in sys.path:
        sys.path.insert(0, str(import_root))

from deep_ai.trainer_v3 import AlphaZeroV3Config  # noqa: E402
from deep_ai.run_store import (  # noqa: E402
    ACTIVE_STATUSES,
    atomic_write_bytes,
    atomic_write_json,
    create_run_layout,
...
def main() -> int:
    ...
    parser.add_argument(
        "--runs-root",
        default=str(RESEARCH_ROOT / "build" / "runs"),
    )
