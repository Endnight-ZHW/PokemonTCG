...
for import_root in (NATIVE_ROOT, PYTHON_ROOT, PRODUCT_PYTHON_ROOT):
    if str(import_root) not in sys.path:
        sys.path.insert(0, str(import_root))

from deep_ai.replay_v3 import ReplayStoreV3  # noqa: E402
from deep_ai.run_control_v3 import TrainingCancelled  # noqa: E402
from deep_ai.run_store import update_run  # noqa: E402
from deep_ai.teacher_v3 import (  # noqa: E402
    generate_teacher_replay_v3,
    teacher_tasks_v3,
)
from deep_ai.trainer_v3 import (  # noqa: E402
    AlphaZeroV3Config,
    AlphaZeroV3Trainer,
)
