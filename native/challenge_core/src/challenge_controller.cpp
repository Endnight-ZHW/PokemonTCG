...
std::string ChallengeController::turn_plan_cache_key(
    ...
    return match_id + "|" + string_field(request, "engine", "turn_beam_v2")
        ...
        + (bool_field(request, "internal_prune_transfer_cycles", true) ? "1" : "0");
}
...
Value ChallengeController::decide_action(
    ...
    if (strategic_engine) {
        ...
        strategic_config.prune_transfer_cycles = bool_field(request, "internal_prune_transfer_cycles", true);
