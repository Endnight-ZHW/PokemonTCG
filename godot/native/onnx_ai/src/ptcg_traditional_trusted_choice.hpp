...
#include "ptcg_traditional_trusted_semantics.hpp"

namespace ptcg::ai::traditional_trusted_detail {

inline std::string choice_option_card_id(
    const Value &option,
    const Value &cards
) {
...
inline std::string choice_option_slot(const Value &option) {
    const Value *reference = field(option, "ref");
    if (reference != nullptr && reference->is_object()) {
...
inline std::int32_t choice_option_player(
    const Value &option,
...
inline bool choice_option_is_hand_card(const Value &option) {
    const Value *reference = field(option, "ref");
    if (reference != nullptr && reference->is_object()) {
...
inline std::string choice_energy_card_id(
...
inline std::string choice_option_energy_card_id(
    const Value &option,
    const Value &cards
) {
    const std::string id = string_field(option, "option_id");
...
inline std::string choice_score_mode(
    const Value &choice,
    std::int32_t actor
) {
...
inline bool discard_fuels_damage_plan(
    const Value &state,
    std::int32_t actor,
...
inline double discard_choice_score(
...
inline double energy_choice_target_value(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
...
inline double energy_source_choice_value(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const std::string &slot,
...
inline double switch_opponent_attack_route_bonus(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
...
inline double target_choice_value(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &choice,
...
inline std::optional<double> base_choice_option_score(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &choice,
...
inline std::vector<std::string> energy_plan_evolution_descendants(
    const Value &cards,
    const Value &decks,
...
inline double energy_attack_plan_for_card(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &source,
...
inline double energy_attack_plan_utility(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline double public_energy_distribution_board_utility(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &cards
