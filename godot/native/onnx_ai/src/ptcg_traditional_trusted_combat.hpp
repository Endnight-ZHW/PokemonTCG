...
inline std::vector<const Value *> board(const Value &state, std::int32_t actor) {
...
inline bool had_knockout(const Value &state, std::int32_t defeated, bool attack_only) {
...
inline void append_flattened_effect(
    const Value &effect,
    std::vector<const Value *> &result
) {
...
inline std::vector<const Value *> flatten_effects(const Value::Array &effects) {
    std::vector<const Value *> result;
    for (const Value &effect : effects) append_flattened_effect(effect, result);
    return result;
}

inline bool branch_has_effect(const Value *branch, const std::string &kind) {
...
inline std::int64_t effect_damage(
...
inline std::int64_t branch_damage(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value *branch,
...
inline bool modifier_kind(
    const Value *pokemon,
    const std::string &kind,
    const std::string &text = {}
);

inline std::int64_t reference_modified_attack_damage(
    const Value &state,
    std::int32_t actor,
...
inline std::int64_t estimated_attack_damage(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
...
inline std::int64_t best_available_damage(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &cards
...
inline std::int64_t best_ready_damage_for_pokemon(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline std::int64_t best_missing(const Value &cards, const Value *pokemon) {
...
inline std::int64_t printed_best_damage(const Value &cards, const Value *pokemon) {
    if (pokemon == nullptr) return 0;
    const Value *definition = card(cards, string_field(*pokemon, "card_id"));
    const auto &attacks = definition == nullptr ? Value::Array{} : array_field(*definition, "attacks");
    std::int64_t best = 0;
...
inline std::int64_t action_strength_damage(
    const Value &cards,
...
inline bool modifier_kind(const Value *pokemon, const std::string &kind, const std::string &text) {
...
inline std::int64_t modifier_sum(const Value *pokemon, const std::string &kind) {
    if (pokemon == nullptr) return 0;
...
inline double deck_pressure(const Value &owner) {
...
inline std::string deck_key(const Value &state, std::int32_t actor) {
...
inline bool energy_matches_profile(
    const Value &cards,
...
inline std::int64_t energy_profile_match_count(
    const Value &cards,
    const std::string &card_id,
    const std::string &key
) {
...
inline double card_priority(const Value &cards, const std::string &card_id, const std::string &key) {
...
inline Value pokemon_with_extra_energy(
    const Value &pokemon,
...
inline std::int64_t best_missing_with_extra(
    const Value &cards,
    const Value *pokemon,
    const std::string &energy_card_id
) {
...
inline bool place_candidate_in_active(
    Value &simulation,
    std::int32_t actor,
    const Value &pokemon,
    const std::string &slot
...
inline std::int64_t estimated_damage_for_pokemon(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline std::int64_t pokemon_attack_damage_ceiling(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline std::int64_t best_pokemon_damage_for_state(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline HighImpactPlan high_impact_attack_plan(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline std::int64_t high_impact_missing_energy(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline bool commands_require_belief_sampling(const Value &commands) {
...
inline std::int64_t best_deterministic_available_damage(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &cards
...
inline bool has_public_tatsugiri_acceleration_target(
    const Value &state,
    std::int32_t actor,
    const Value &cards
) {
...
inline double energy_plan_target_bonus(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &pokemon,
...
inline bool has_better_bench_energy_plan(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const std::string &energy_card_id,
