...
#include "ptcg_traditional_trusted_combat.hpp"

namespace ptcg::ai::traditional_trusted_detail {

inline Value::Array expand_deck(const Value &decks, const std::string &key) {
...
inline std::vector<std::string> pre_evolution_ids(
    const Value &cards,
    const Value &decks,
...
inline double active_evolve_blocking_penalty(
...
inline bool redundant_same_pokemon_retreat(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
...
inline bool retreat_has_good_target(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &active_pokemon,
...
inline double focus_multiplier(
    const Value &state,
    std::int32_t actor,
    const Value &cards,
    const Value &decks,
...
inline double active_prize_threat(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &cards
...
inline bool has_energy_target(const Value &state, std::int32_t actor, const Value &cards) {
...
inline std::int64_t count_in_play(
    const Value &state,
    std::int32_t actor,
...
inline std::int64_t count_in_zone(
...
inline double core_evolution_line_card_bonus(
    const Value &state,
    std::int32_t actor,
    const std::string &card_id,
    const std::string &key,
...
inline bool energy_improves_attack_readiness(
    const Value &state,
    std::int32_t actor,
...
inline std::int64_t helpful_hand_energy_count(
    const Value &state,
    std::int32_t actor,
    const Value &cards
) {
...
inline double lone_active_backup_search_bonus(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const Value &cards
...
inline bool has_core_basic_out_in_deck(
    const Value &state,
    std::int32_t actor,
    const std::string &key,
    const Value &cards
...
inline double bench_setup_search_card_bonus(
    const RulesSession &position,
    const Value &state,
    std::int32_t actor,
    const std::string &card_id,
