...
const PROFILES := {
	"fire": {
		...
		"setup": ["svi-chim", "svi-ente", "svi-hrot", "svi-chiy"],
	...
	"water": {
		"core": ["sv2-grex"],
		"engine": ["sv2-38", "sv2-39", "sv2-staryu", "sv2-starm", "sv2-cand"],
		"setup": ["sv2-38", "sv2-staryu", "sv2-tatsu", "sv2-keldeo", "sv1-49"],
	...
	"lightning": {
		...
		"setup": ["svl-thun", "svl-emol", "svl-chat", "svl-zera", "svl-mare2", "svl-chin"],
