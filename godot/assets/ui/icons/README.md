...
uses a 24 × 24 view box, an approximately 2 px rounded monochrome stroke, and no
embedded branding. Godot Theme icon colors tint the white source artwork for
normal, hover, pressed, focused, and disabled states.
