...
$zipPath = Join-Path $distRoot 'PokemonTCG-Windows-x86_64-0.2.0.zip'
$apkPath = Join-Path $distRoot 'PokemonTCG-Android-arm64-0.2.0-test.apk'
...
foreach ($expected in @(
    "package: name='com.pokemontcg.game' versionCode='2' versionName='0.2.0'",
    "sdkVersion:'28'",
    "targetSdkVersion:'35'",
